...
def main(theme):
    ...
    if int(response.getcode()) == 200:
        ...
        pdfkit.from_string(
            tmp, "{}-lecturas.pdf".format(theme), options=options, css="dtb.css",
        )
    else:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Palabra de Léon-Dufour a PDF")
    parser.add_argument("theme", type=string, help="Palabra")
